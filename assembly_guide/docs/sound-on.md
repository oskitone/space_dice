...
- If the 4040 outputs square waves, what kind of waveform do you get when they're connected?
  - Hint: any low GND output will sink any high VCC output it contacts...
